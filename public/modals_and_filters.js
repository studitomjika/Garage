...
async function requestFilteredCarDeals_viaAPI(){
  ...
  const parameters = {
    kilometers: document.getElementById("km-select").value,
  ...
  await fetch("https://127.0.0.1:8000/api/voiture_d_occasions?kilometers%5Bbetween%5D=" + parameters.kilometers + "&year%5Bbetween%5D=" + parameters.year + "&price%5Bbetween%5D=" + parameters.price, {
    method: "GET",
    headers: {
